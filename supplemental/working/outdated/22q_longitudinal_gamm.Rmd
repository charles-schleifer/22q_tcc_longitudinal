...
```{r message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
# file name to look for
wtc_name_trio <- "resting_fc_network_WholeThal_Cortex_Atlas_s_hpss_res-mVWMWB1d_lpss_CABNP.csv"
wtc_name_prisma <- "restingAP_fc_network_WholeThal_Cortex_Atlas_s_hpss_res-mVWMWB1d_lpss_CABNP.csv"
