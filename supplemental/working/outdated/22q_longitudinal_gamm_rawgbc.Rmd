...
tc_name_trio <- "resting_fc_network_Cortex_RawGBC_Atlas_s_hpss_res-mVWMWB1d_lpss_CABNP.csv"
tc_name_prisma <- "restingAP_fc_network_Cortex_RawGBC_Atlas_s_hpss_res-mVWMWB1d_lpss_CABNP.csv"
...
plot_gamm_points_tc_combat <- function(name,xlab="", ylab="",ylim=c(-0.3,.3),xlim=c(5.9,22)){
...
lapply(tc_names_combat,function(x) plot_gamm_points_tc_combat(x,xlab="Age",ylab="GBC"))
```
