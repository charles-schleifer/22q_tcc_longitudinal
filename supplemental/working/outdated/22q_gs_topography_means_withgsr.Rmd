...
packages <- c("conflicted", "here", "magrittr", "mgcv", "gratia", "lme4", "lmerTest", "invgamma", "longCombat", "ciftiTools", "readxl", "dplyr", "data.table", "DescTools","tableone", "tibble", "reshape2", "viridis", "scico","RColorBrewer", "ggplot2", "gridExtra", "ggpubr","stringr")
...
#gbc_name_trio <- "resting_fc_gbc_s_hpss_res-mVWMWB1d_gbc_mFz_0.dtseries.nii"
#gbc_name_prisma <- "restingAP_fc_gbc_s_hpss_res-mVWMWB1d_gbc_mFz_0.dtseries.nii"
...
## get mean ciftis by group and age range
```{r}
all_gbc_del <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="PATIENT-DEL")$MRI_S_ID]
all_gbc_hcs <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="CONTROL")$MRI_S_ID]

all_gbc_del_6_14 <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="PATIENT-DEL" & AGE >6 & AGE < 14 )$MRI_S_ID]
all_gbc_del_14_22 <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="PATIENT-DEL" & AGE >= 14 & AGE < 22 )$MRI_S_ID]

all_gbc_hcs_6_14 <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="CONTROL" & AGE >6 & AGE < 14 )$MRI_S_ID]
all_gbc_hcs_14_22 <- all_gbc[filter(ucla_demo_hcs_del, SUBJECT_IDENTITY=="CONTROL" & AGE >= 14 & AGE < 22 )$MRI_S_ID]


# function to merge list of n xii into one xii with n cols
merge_xifti_list <- function(list){
  merged <- NULL
  # loop through list, merging each xii with previous xiis
  for(i in 1:length(list)) {   
    xii <- list[[i]]
    if(is.null(merged)){
      print("...starting merged xii")
      merged <- xii
    }else{
      print(paste("...merging xii",as.character(i),"of",as.character(length(list))))
      merged <- merge_xifti(merged,xii)
    }
  }
  return(merged)
}
...
xii_gbc_del <- merge_xifti_list(all_gbc_del)
xii_gbc_hcs <- merge_xifti_list(all_gbc_hcs)
xii_gbc_del_6_14 <- merge_xifti_list(all_gbc_del_6_14)
xii_gbc_hcs_6_14 <- merge_xifti_list(all_gbc_hcs_6_14)
xii_gbc_del_14_22 <- merge_xifti_list(all_gbc_del_14_22)
xii_gbc_hcs_14_22 <- merge_xifti_list(all_gbc_hcs_14_22)

xii_gbc_del_mean <- apply_xifti(xii_gbc_del, margin=1, mean)
xii_gbc_hcs_mean <- apply_xifti(xii_gbc_hcs, margin=1, mean)
xii_gbc_del_6_14_mean <- apply_xifti(xii_gbc_del_6_14, margin=1, mean)
xii_gbc_hcs_6_14_mean <- apply_xifti(xii_gbc_hcs_6_14, margin=1, mean)
xii_gbc_del_14_22_mean <- apply_xifti(xii_gbc_del_14_22, margin=1, mean)
xii_gbc_hcs_14_22_mean <- apply_xifti(xii_gbc_hcs_14_22, margin=1, mean)

xii_gbc_gdiff_all <- xii_gbc_del_mean - xii_gbc_hcs_mean
xii_gbc_gdif_6_14 <- xii_gbc_del_6_14_mean - xii_gbc_hcs_6_14_mean
xii_gbc_gdif_14_22 <- xii_gbc_del_14_22_mean - xii_gbc_hcs_14_22_mean

view_xifti_surface(xii_gbc_del_mean, title="Global Signal Topography 22qDel mean", zlim=c(0,0.15), cex.title = 1.3)
view_xifti_surface(xii_gbc_hcs_mean, title="Global Signal Topography HCS mean",zlim=c(0,0.15), cex.title = 1.3)

view_xifti_surface(xii_gbc_gdiff_all, title="GBC Del-HCS group difference", zlim=c(-0.03,0.03),cex.title = 1.3, colors=pal_red_blue())
view_xifti_volume(xii_gbc_gdiff_all, title="GBC Del-HCS group difference", zlim=c(-0.03,0.03),cex.title = 1.3, colors=pal_red_blue())

view_xifti_surface(xii_gbc_gdif_6_14, title="GBC Del-HCS age 6-14 group difference",zlim=c(-0.03,0.03), cex.title = 1.3, colors=pal_red_blue())
view_xifti_volume(xii_gbc_gdif_6_14, title="GBC Del-HCS age 6-14 group difference",zlim=c(-0.03,0.03), cex.title = 1.3, colors=pal_red_blue())

view_xifti_surface(xii_gbc_gdif_14_22, title="GBC Del-HCS age 14-22 group difference",zlim=c(-0.03,0.03), cex.title = 1.3, colors=pal_red_blue())
view_xifti_volume(xii_gbc_gdif_14_22, title="GBC Del-HCS age 14-22 group difference",zlim=c(-0.03,0.03), cex.title = 1.3, colors=pal_red_blue())
