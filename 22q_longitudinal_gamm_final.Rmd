...
```{r}
plot_gamm_resid_tc <- function(name,xlab="", ylab="",ylim=c(-1,1.1),xlim=c(5.9,23)){
  ...
  ggplot()+
    geom_point(data=resid_hcs, aes(x=AGE, y=yvar), color="deepskyblue") +
    geom_point(data=resid_del, aes(x=AGE, y=yvar), color="red") +
...
```{r}
add_partial_residuals(data=demo_mri_tc_hcs_del_combat,model=gamm_tc_all_combat[["Frontoparietal.combat"]])

function(name,xlab="", ylab="",ylim=c(-1,1.1),xlim=c(5.9,23)){
